...
public class BasketAdapter extends RecyclerView.Adapter<BasketAdapter.ViewHolder> {
    ...
    private List<BasketShoe> basketShoes;

    private Context context;

    public BasketAdapter(Context context, List<BasketShoe> basketShoes) {
    ...
    public void onBindViewHolder(BasketAdapter.ViewHolder holder, int position) {
        BasketShoe basketShoe = basketShoes.get(position);
        ...
        ViewHolder(View view) {
            ...
            clBasket.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    BasketShoe basketShoe = basketShoes.get(getAdapterPosition());
                    String uniquekey = String.valueOf(basketShoe.getUniquekey());
